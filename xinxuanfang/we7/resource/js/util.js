...
util.base64Encode = function(e) {
  ...
  if (e && ((e = e.split("/"))[0] && (a += "c=" + e[0] + "&"), e[1] && (a += "a=" + e[1] + "&"),
    ...
    for (var r in t) r && t.hasOwnProperty(r) && t[r] && (a += r + "=" + t[r] + "&");
  return a;
  ...
  if (-1 == n.indexOf("http://") && -1 == n.indexOf("https://") && (n = util.url(n)),
    getUrlParam(n, "state") || e.data && e.data.state || !t || (n = n + "&state=we7sid-" + t), !e.data || !e.data.m) {
  ...
  var t, n = require("md5.js"),
    a = getApp();
  (e = e || {}).cachetime = e.cachetime ? e.cachetime : 0, e.showLoading = void 0 === e.showLoading || e.showLoading, e.hideLoading = void 0 === e.hideLoading || e.hideLoading;
  var r = wx.getStorageSync("userInfo").sessionid,
    i = e.url;
  if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)),
    getUrlParam(i, "state") || e.data && e.data.state || !r || (i = i + "&state=we7sid-" + r), !e.data || !e.data.m) {
  ...
  if (wx.showNavigationBarLoading(), e.showLoading && util.showLoading(), e.cachetime) {
    ...
    if (c && c.data) {
      if (c.expire > f) return e.complete && "function" == typeof e.complete && e.complete(c),
        ...
        e.hideLoading ? wx.hideLoading() : '', wx.hideNavigationBarLoading(), !0;
  ...
  wx.request((t = {
    ...
    if (wx.hideNavigationBarLoading(), e.hideLoading ? wx.hideLoading() : '', t.data.errno) {
    ...
    wx.hideNavigationBarLoading(), e.hideLoading ? wx.hideLoading() : '';
...
}, util.getUserInfo = function(e, tt) {
  var t, tt, n = function() {
  ...
  a.sessionid && a.wxInfo ? util.checkSession({
    success: function() {
      tt ? util.upadteUser(tt, function(t) {
        "function" == typeof e && e(t);
  ...
  if (n)
    for (var a in n) e = e.replace(n[a], "[U+" + n[a].codePointAt(0).toString(16).toUpperCase() + "]");
  return e;
}, util.date = function() {
