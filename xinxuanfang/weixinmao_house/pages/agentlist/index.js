...
Page({
    ...
    onShow: function(t) {
        ...
        var a = this, n = wx.getStorageSync("cityinfo");
        n ? (console.log(n.name), wx.setStorageSync("city", n.name), a.initpage()) : (qqmapsdk = new QQMapWX({
            ...
            success: function(t) {
                qqmapsdk.reverseGeocoder({
                    ...
                    success: function(t) {
                        var n = t.result.address_component.city, e = n.substr(0, n.length - 1);
                        wx.setStorageSync("city", e), a.initpage();
                    }
                });
            },
            fail: function() {},
